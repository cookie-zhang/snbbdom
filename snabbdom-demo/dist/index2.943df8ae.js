...
},{"./vnode":"node_modules/snabbdom/es/vnode.js","./is":"node_modules/snabbdom/es/is.js","./htmldomapi":"node_modules/snabbdom/es/htmldomapi.js","./h":"node_modules/snabbdom/es/h.js","./thunk":"node_modules/snabbdom/es/thunk.js"}],"src/index2.js":[function(require,module,exports) {
"use strict";
...
var vnode = (0, _snabbdom.h)('div#contanier', [(0, _snabbdom.h)('h1', 'hello snabbdom'), (0, _snabbdom.h)('p', '这是一个p标签')]);
var app = document.querySelector('#app');
var oldVode = patch(app, vnode);
setTimeout(function () {
  vnode = (0, _snabbdom.h)('div#constiner', [(0, _snabbdom.h)('h1', 'hello wold new node'), (0, _snabbdom.h)('p', 'hello p new')]);
  patch(oldVode, vnode); // 清空页面的元素 
  // 错误做法 patch(oldVode, null)
  // 正确
}, 2000);
setTimeout(function () {
  debugger;
  patch(oldVode, (0, _snabbdom.h)('!'));
}, 3000);
